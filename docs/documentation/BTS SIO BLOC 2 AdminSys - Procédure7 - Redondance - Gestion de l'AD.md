...
![](C:\documentation_github\CUBDOCUMENTATIONDORTMUND\docs\medias\AD_redondant1.png)

On va faire supprimer des rôles et fonctionnalité 

![](C:\documentation_github\CUBDOCUMENTATIONDORTMUND\docs\medias\AD_redondant2.png)

on sélectionne AD DS pour le supprimez 

![](C:\documentation_github\CUBDOCUMENTATIONDORTMUND\docs\medias\AD_redondant3.png)

on fait supprimez

![](C:\documentation_github\CUBDOCUMENTATIONDORTMUND\docs\medias\AD_redondant4.png)

Il faut faire rétrograder le contrôleur de domaine

![](C:\documentation_github\CUBDOCUMENTATIONDORTMUND\docs\medias\AD_redondant5.png)

on sélectionne forcer la suppression 

![](C:\documentation_github\CUBDOCUMENTATIONDORTMUND\docs\medias\AD_redondant6.png)

On fait procéder à la suppression

![](C:\documentation_github\CUBDOCUMENTATIONDORTMUND\docs\medias\AD_redondant7.png)
...
![](C:\documentation_github\CUBDOCUMENTATIONDORTMUND\docs\medias\AD_redondant8.jpeg)

On va dans le petit drapeau et on fait promouvoir 

![](C:\documentation_github\CUBDOCUMENTATIONDORTMUND\docs\mediasAD_redondant9.png)
...
![](C:\documentation_github\CUBDOCUMENTATIONDORTMUND\docs\medias\AD_redondant10.png)

On mais le mot de passe pour une récupération future

![](C:\documentation_github\CUBDOCUMENTATIONDORTMUND\docs\medias\AD_redondant11.jpeg)
...
BTS SIO – BLOC2 – *fiche procédure n°5 – Configuration Failover Windows Server 2012*Page 4![](C:\documentation_github\CUBDOCUMENTATIONDORTMUND\docs\medias\AD_redondant12.png)
