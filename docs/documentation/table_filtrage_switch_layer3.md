...
## Règles ACL appliquées de filtrage du Switch de layer 3
...
# Vlan client
    ...
    n5 permit tcp 192.168.4.128 0.0.0.63 192.168.4.0 0.0.0.127 eq 22
    n5 permit tcp 192.168.4.128 0.0.0.63 192.168.4.0 0.0.0.127 eq 3389
    n6 permit ip 192.168.4.128 0.0.0.63 host 192.168.4.1
...
# Vlan Production
    ...
    n1 pas a mettre 
    n2 permit tcp any any established
    n3 deny ip 192.168.4.0 0.0.0.127 192.168.4.192 0.0.0.127
    n4 deny ip 192.168.4.0 0.0.0.127 192.168.4.128 0.0.0.63
    n5 permit ip 192.168.4.0 0.0.0.127 any
...
# Vlan AdminSYS
    ...
    n3 permit icmp 192.168.4.192 0.0.0.15 192.168.4.128 0.0.0.63
    n4 deny ip 192.168.4.192 0.0.0.15 192.168.4.128 0.0.0.63
    n5 deny tcp 192.168.4.192 0.0.0.15 192.168.4.0 0.0.0.127 eq 22
    n5 deny tcp 192.168.4.192 0.0.0.15 192.168.4.0 0.0.0.127 eq 3389
    n6 permit ip 192.168.4.192 0.0.0.15 host 192.168.4.1
    ...
    n7 deny udp 192.168.4.192 0.0.0.15 host 192.168.4.11 eq 53
    n8 deny tcp 192.168.4.192 0.0.0.15 host 192.168.4.125 eq 443
    n9 permit ip 192.168.4.192 0.0.0.15 192.168.4.0 0.0.0.127
